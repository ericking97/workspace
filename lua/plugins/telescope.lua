...
return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    -- NOTE: Keymaps
    nnoremap('<leader>sh', builtin.help_tags, { desc = '[S]earch [Help]' })
    nnoremap('<leader>sk', builtin.keymaps, { desc = '[S]earch [K]eymaps' })
    nnoremap('<leader>ff', builtin.find_files, { desc = '[F]ind [F]iles' })
    nnoremap('<leader>sw', builtin.grep_string, { desc = '[S]earch [W]ord' })
    nnoremap('<leader>fw', builtin.live_grep, { desc = '[F]ind [W]ord' })
